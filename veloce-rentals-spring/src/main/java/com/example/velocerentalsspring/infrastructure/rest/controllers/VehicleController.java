...
public class VehicleController {
  ...
  @PostMapping("/create")
  public ResponseEntity<VehicleOutDTO> createVehicle(@RequestBody CreateVehicleDTO vehicle) {
  ...
  @PutMapping("/update")
  public ResponseEntity<VehicleOutDTO> updateVehicle(@RequestBody UpdateVehicleDTO vehicleDTO){
